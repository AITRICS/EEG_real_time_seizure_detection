...
class RESNET18_CONV2D_V1(nn.Module):
    def __init__(self, args, device):
        super(RESNET18_CONV2D_V1, self).__init__()
        self.args = args

        num_classes = self.args.output_dim
        self.enc_model = self.args.enc_model
        # num_blocks = [4,4,4,4] # for rfield 109
        num_blocks = [3,3,3,3] # original rfield 49
        block = BasicBlock
        ...
        self.layer4 = self._make_layer(block, 512, num_blocks[3], self.is_psd, stride=2)
