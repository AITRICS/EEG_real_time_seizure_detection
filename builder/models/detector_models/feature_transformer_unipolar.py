...
class EEG_FEATURE_TRANSFORMER_V15_UNIPOLAR(nn.Module):
    def __init__(self, args, device):
        super(EEG_FEATURE_TRANSFORMER_V15_UNIPOLAR, self).__init__()      
        self.args = args
    ...
    def init_state(self, device):
        self.hidden = ((torch.zeros(1, self.args.batch_size, 19).to(device), torch.zeros(1, self.args.batch_size, 19).to(device)))
